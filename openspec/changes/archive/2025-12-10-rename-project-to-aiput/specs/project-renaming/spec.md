...
- "QAA-AirType" → "AIPut"
- "qaa-airtype" → "aiput"
- "QAA-Tools/qaa-airtype" → newbe36524/AIPut

### Files Requiring Updates
1. `pyproject.toml` - Project name, repository URLs, and metadata
2. `src/remote_server_linux_kde_xwayland.py` - GUI titles and tray icon
3. `openspec/project.md` - Project documentation
4. Any README files
5. Installation scripts that reference the project name